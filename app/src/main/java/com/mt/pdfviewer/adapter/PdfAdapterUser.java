...
public class PdfAdapterUser extends RecyclerView.Adapter<PdfAdapterUser.PdfUserViewHolder> implements Filterable {
    ...
    public PdfAdapterUser(Context context, ArrayList<PdfModel> pdfArrayList) {
    ...
    @NonNull
    @Override
    public PdfAdapterUser.PdfUserViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        binding = RvitemPdfBinding.inflate(LayoutInflater.from(context), parent, false);
        return new PdfAdapterUser.PdfUserViewHolder(binding.getRoot());
    }
